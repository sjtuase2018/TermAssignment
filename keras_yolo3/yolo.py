...
class YOLO(object):
    ...
    def detect_image(self, image):
        ...
        font = ImageFont.truetype(font=basedir+'/font/FiraMono-Medium.otf', size=np.floor(3e-2 * image.size[1] + 0.5).astype('int32'))
        ...
        return image, out_boxes, out_scores, [self.class_names[x] for x in out_classes]
